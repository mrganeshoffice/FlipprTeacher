...
public class AttemptByDescriptiveAdapter(

    var holders: AllMcq_Fragment.descriptiveAdapter.ViewHolder
) : RecyclerView.Adapter<AttemptByDescriptiveAdapter.custom>() {
