...
public class CheckBoxAdapterLevels extends RecyclerView.Adapter<CheckBoxAdapterLevels.Customm> {
    Context context;
    int durations =1;
    ...
    public CheckBoxAdapterLevels(Context context, ArrayList<ModelCheckedActivities> list) {
