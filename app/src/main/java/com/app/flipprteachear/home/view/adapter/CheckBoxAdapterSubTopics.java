...
public class CheckBoxAdapterSubTopics extends RecyclerView.Adapter<CheckBoxAdapterSubTopics.Customm> {
    Context context;
    int durations =1;
    ...
    public CheckBoxAdapterSubTopics(Context context, ArrayList<ModelCheckedActivities> list) {
    ...
    public void onBindViewHolder(@NonNull Customm holder, int position) {
        ...
        if(mlist.get(position).isSelected()) holder.CheckedTextView.setChecked(true);
