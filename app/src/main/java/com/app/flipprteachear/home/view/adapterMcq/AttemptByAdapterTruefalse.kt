...
public class AttemptByAdapterTruefalse(

    var holders: AllMcq_Fragment.trueFalseAdapter.ViewHolder
) : RecyclerView.Adapter<AttemptByAdapterTruefalse.custom>() {
    ...
    override fun onBindViewHolder(holder: custom, position: Int) {
       ...
       /* try {
        ...
        holder.itemView.setOnClickListener {
            ...
            if (isRvImageFull)
                holders.rvImageFull.setVisibility(View.VISIBLE)
            else holders.rvImageFull.setVisibility(View.GONE
            )
        }
